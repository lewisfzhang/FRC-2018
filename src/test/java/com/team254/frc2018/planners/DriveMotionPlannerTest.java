...
public class DriveMotionPlannerTest {
    ...
    public void test() {
        ...
        motion_planner.setTrajectory(new TrajectoryIterator<>(new TimedView<>(motion_planner.generateTrajectory(Arrays.asList(new Pose2d(new Translation2d(0.0, 0.0), Rotation2d.identity()),
        ...
        while(!motion_planner.isDone()) {
            ...
            System.out.println("t: " + t + ", leftv: " + output.left_feedforward_voltage + ", rightv: " + output.right_feedforward_voltage);
            t += 0.01;
        }
