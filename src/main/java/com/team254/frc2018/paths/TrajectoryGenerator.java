...
public class TrajectoryGenerator {
    ...
    public static final Pose2d kFarScaleEmptyPose = new Pose2d(new Translation2d(250.0, 201.0), Rotation2d
            .fromDegrees(-10.0+180.0));
    public static final Pose2d kFarScaleFullPose = new Pose2d(new Translation2d(250.0, 206.0), Rotation2d.fromDegrees
            (-15.0+180.0));
    public static final Pose2d kFarScaleFullPose1 = new Pose2d(new Translation2d(250.0, 206.0 - 2.0), Rotation2d.fromDegrees
            (-15.0+180.0));
    public static final Pose2d kFarScaleFullPose2 = new Pose2d(new Translation2d(250.0, 206.0 - 4.0), Rotation2d.fromDegrees
            (-15.0+180.0));
    ...
    public static final Pose2d kFarCube1Pose = new Pose2d(new Translation2d(183.0, 190.0), Rotation2d.fromDegrees(180.0 + 25.0));
