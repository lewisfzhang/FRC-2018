...
public class SuperstructureConstants {
    public static final double kWristMaxAngle = 180;
    ...
    public static final double kWristStowForMinElevatorMoveDistance = 10;
    public static final double kWristStowedPosition = 90;
